...
exports.deleteUser = exports.updateRights = exports.update = exports.create = exports.getById = exports.getAll = void 0;
const userService = __importStar(require("../services/user.service"));
const error_middleware_1 = require("../middleware/error.middleware");
exports.getAll = (0, error_middleware_1.asyncHandler)(async (_req, res) => {
...
exports.updateRights = (0, error_middleware_1.asyncHandler)(async (req, res) => {
